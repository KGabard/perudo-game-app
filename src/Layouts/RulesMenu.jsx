      ...
      <div className="rulesMenu__window" ref={windowRef}>
        ...
        <section className="rulesMenu__body">
          <p className="rulesMenu__paragraph">
            En début de partie tous les joueurs reçoivent cinq dés
            aléatoirement. Chaque joueur ne doit connaître que la valeur de ses
            dés.
          </p>
          <p className="rulesMenu__paragraph">
            Le premier joueur fait une enchère. Il annonce une valeur de dé et
            un nombre de dés, principalement en fonction de son tirage.
            Théoriquement, il doit se rapprocher au mieux de ce qu'il estime
            être la réalité, mais il peut aussi bluffer.
          </p>
          <p className="rulesMenu__paragraph">
        ...
        <ul className="rulesMenu__list">
          ...
          <li>
            ...
            fausse et il annonce « dudo » (je doute),
          </li>
          <li>
            Calza : Il peut estimer que l'affirmation du premier joueur est
            parfaitement juste et il annonce « calza » (calé).
          </li>
        </ul>
        <h3 className="rulesMenu__subtitle">{'A) Surenchère'}</h3>
        <p className="rulesMenu__body">
          Pour surenchérir, le joueur choisit une seule des deux options
          suivantes :
        </p>
        <ul className="rulesMenu__list">
        ...
        <section className="rulesMenu__body">
          <p className="rulesMenu__paragraph">
            Une fois qu'il a fait ce choix, il annonce sa nouvelle proposition
            et c'est au joueur situé à sa gauche de parler. Ce dernier peut dire
            « dudo » ou surenchérir et ainsi de suite.
          </p>
          <p className="rulesMenu__paragraph">
            Exemple : Le joueur précédent a annoncé « il y a au moins 5 dés de
            valeur 4 autour de cette table ». On peut annoncer « il y a au moins
        ...
        <section className="rulesMenu__body">
          <p className="rulesMenu__paragraph">
            Les dés de valeur 1 - appelés "paco" - sont spéciaux, ce sont des
            jokers. Tout d'abord, ils servent de joker lorsque les dés sont
            révélés suite à un « dudo ». Ils ont toujours la même valeur que
            celle de la dernière proposition exprimée.
          </p>
          <p className="rulesMenu__paragraph">
